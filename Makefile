...
LIBFTS = ft_atoi.c ft_bzero.c ft_charneg.c ft_hidenp.c ft_htoa.c \
		 ft_isdigit.c ft_itoa.c ft_len.c ft_ltoa.c ft_memalloc.c \
		 ft_neg.c ft_oltoa.c ft_otoa.c ft_putchar.c ft_putnbr.c \
		 ft_putstr.c ft_putwstr.c ft_strchr.c ft_strdup.c ft_strlen.c  \
		 ft_strncat.c ft_strncpy.c ft_strnew.c ft_strsub.c ft_toupper.c \
		 ft_utoa.c ft_ultoa.c ft_wstrlen.c
SRCS = ft_printf.c ft_find_spec.c ft_flags.c ft_str.c ft_wstr.c ft_poi.c \
	   ft_nbr.c ft_lnbr.c ft_oct.c ft_octl.c ft_ulnbr.c ft_unbr.c \
	   ft_hex.c ft_alt_hex.c ft_char.c
